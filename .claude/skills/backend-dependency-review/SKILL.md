...
- [ ] **Overengineering pass.** Пройди всё, что стоит поверх базовой единицы из блока Scope — contracts, adapters, port, фабрики и слои-прослойки — по критериям из INVERSION.md; сама базовая единица не оценивается. Критерий: у каждой abstraction вердикт «оправдана / лишняя» с причиной.
