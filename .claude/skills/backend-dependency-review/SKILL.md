...
Владелец — `backend-persistence-review`: transaction boundaries, concurrency, constraints хранилища, стоимость запросов, idempotency записей, совместимость миграций. Компонент знает тип ORM или тип ошибки хранилища — здесь; что операция делает со state при параллельном или частичном выполнении — там.
